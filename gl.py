...
class Renderer(object):
    ...
    def shader(self, x, y):
        ...
        #color(90, 174, 233)
        #color(122, 170, 207)
        if x < (1160 + random.randint(0, 20)):
            if y < (760 + random.randint(0, 25)):
                return color(5, 18, 38)
            elif y >= 760 and y < (785 + random.randint(0, 25)):
                return color(7, 37, 68)
            elif y >= 785 and y < (820 + random.randint(0, 5)):
                return color(25, 78, 128)
            elif y >= 820 and y < (855 + random.randint(0, 5)):
                return color(50, 141, 221)
            elif y >= 855 and y < (880 + random.randint(0, 5)):
                return color(90, 174, 233)
            elif y >= 880 and y < (890 + random.randint(0, 25)):
                return color(122, 170, 207)
            elif y >= 890 and y < (905 + random.randint(0, 10)):
                return color(25, 78, 128)
            elif y >= 905 and y < (925 + random.randint(0, 5)):
                return color(50, 141, 221)
            elif y >= 925 and y < (940 + random.randint(0, 5)):
                return color(90, 174, 233)
            elif y >= 940 and y < (950 + random.randint(0, 25)):
                return color(122, 170, 207)
            elif y >= 950 and y < (970 + random.randint(0, 15)):
                return color(25, 78, 128)
            elif y >= 970 and y < (980 + random.randint(0, 5)):
                if x < (1200 + random.randint(0, 100)) and x > (950 + random.randint(0, 100)):
                    return color(230, 230, 230)
                else:
                    return color(50, 141, 221)
            elif y >= 980 and y < (990 + random.randint(0, 5)):
                return color(90, 174, 233)
            elif y >= 990 and y < (1010 + random.randint(0, 15)):
                return color(122, 170, 207)
            elif y >= 1010 and y < (1030 + random.randint(0, 10)):
                return color(25, 78, 128)
            elif y >= 1030 and y < (1045 + random.randint(0, 5)):
                return color(50, 141, 221)
            elif y >= 1045 and y < (1055 + random.randint(0, 5)):
                return color(90, 174, 233)
            elif y >= 1055 and y < (1070 + random.randint(0,10)):
                return color(122, 170, 207)
            elif y >= 1070 and y < (1095 + random.randint(0, 5)):
                return color(25, 78, 128)
            elif y >= 1095 and y < (1110 + random.randint(0, 15)):
                return color(90, 174, 233)
            elif y >= 1110 and y < (1130 + random.randint(0, 15)):
                if x < (950 + random.randint(0, 100)):
                    return color(230, 230, 230)
                else:
                    return color(50, 141, 221)
            elif y >= 1130 and y < (1140 + random.randint(0, 25)):
                return color(122, 170, 207)
            elif y >= 1140 and y < (1150 + random.randint(0, 5)):
                return color(25, 78, 128)
            elif y >= 1150 and y < (1175 + random.randint(0, 15)):
                return color(90, 174, 233)
            elif y >= 1175 and y < (1190 + random.randint(0, 5)):
                return color(50, 141, 221)
            elif y >= 1190 and y < (1200 + random.randint(0, 5)):
                return color(25, 78, 128)
            elif y >= 1200 and y < (1220 + random.randint(0, 15)):
                return color(90, 174, 233)
            elif y >= 1220 and y < (1240 + random.randint(0, 10)):
                return color(50, 141, 221)
            elif y >= 1240 and y < (1250):
                if x < (950 + random.randint(0, 100)):
                    return color(230, 230, 230)
                else:
                    return color(122, 170, 207)
            elif y >= 1250 and y < (1265 + random.randint(0, 25)):
                return color(50, 141, 221)
        elif x > (1160 + random.randint(0, 10)) and x < (1200 + random.randint(0, 10)):
            if y < (780 + random.randint(0, 25)):
                return color(5*0.7, 18*0.7, 38*0.7)
            elif y >= 780 and y < (795 + random.randint(0, 25)):
                return color(7*0.7, 37*0.7, 68*0.7)
            elif y >= 795 and y < (820 + random.randint(0, 5)):
                return color(25*0.7, 78*0.7, 128*0.7)
            elif y >= 820 and y < (855 + random.randint(0, 5)):
                return color(50*0.7, 141*0.7, 221*0.7)
            elif y >= 855 and y < (880 + random.randint(0, 5)):
                return color(90*0.7, 174*0.7, 233*0.7)
            elif y >= 880 and y < (890 + random.randint(0, 25)):
                return color(122*0.7, 170*0.7, 207*0.7)
            elif y >= 890 and y < (905 + random.randint(0, 10)):
                return color(25*0.7, 78*0.7, 128*0.7)
            elif y >= 905 and y < (925 + random.randint(0, 5)):
                return color(50*0.7, 141*0.7, 221*0.7)
                ...
                if x < (1200 + random.randint(0, 100)) and x > (950 + random.randint(0, 100)):
                    return color(230*0.7, 230*0.7, 230*0.7)
                else:
                    return color(50*0.7, 141*0.7, 221*0.7)
            elif y >= 980 and y < (990 + random.randint(0, 5)):
                return color(90*0.7, 174*0.7, 233*0.7)
                ...
                return color(50*0.7, 14*0.71, 221*0.7)
            elif y >= 1045 and y < (1055 + random.randint(0, 5)):
                return color(90*0.7, 174*0.7, 233*0.7)
            elif y >= 1055 and y < (1070 + random.randint(0,10)):
                return color(122*0.7, 170*0.7, 207*0.7)
            ...
            if y < (780 + random.randint(0, 10)):
                return color(5*0.6, 18*0.6, 38*0.6)
            elif y >= 780 and y < (795 + random.randint(0, 25)):
                return color(7*0.6, 37*0.6, 68*0.6)
            elif y >= 795 and y < (820 + random.randint(0, 5)):
                return color(25*0.6, 78*0.6, 128*0.6)
            elif y >= 820 and y < (855 + random.randint(0, 5)):
                return color(50*0.6, 141*0.6, 221*0.6)
            elif y >= 855 and y < (880 + random.randint(0, 5)):
                return color(90*0.6, 174*0.6, 233*0.6)
            elif y >= 880 and y < (890 + random.randint(0, 25)):
                return color(122*0.6, 170*0.6, 207*0.6)
            elif y >= 890 and y < (905 + random.randint(0, 10)):
                return color(25*0.6, 78*0.6, 128*0.6)
            elif y >= 905 and y < (925 + random.randint(0, 5)):
                return color(50*0.6, 141*0.6, 221*0.6)
                ...
                if x < (1200 + random.randint(0, 100)) and x > (950 + random.randint(0, 100)):
                    return color(230*0.6, 230*0.6, 230*0.6)
                else:
                    return color(50*0.6, 141*0.6, 221*0.6)
            elif y >= 980 and y < (990 + random.randint(0, 5)):
                return color(90*0.6, 174*0.6, 233*0.6)
                ...
                return color(50*0.6, 14*0.61, 221*0.6)
            elif y >= 1045 and y < (1055 + random.randint(0, 5)):
                return color(90*0.6, 174*0.6, 233*0.6)
            elif y >= 1055 and y < (1070 + random.randint(0,10)):
                return color(122*0.6, 170*0.6, 207*0.6)
...
r.load('./models/sphere.obj', (2, 2, 2), (500, 500, 500))
####################################
